...
@Component
public class PreAutorizacionRechazadaAction implements Action<PagoEstado, PagoEvento> {

   @Override
   public void execute(StateContext<PagoEstado, PagoEvento> stateContext) {
      System.out.println("Enviando Notificacion de PreAutorizacionRechazada");
   }
}
